...
# NOTE: TestRelayIntentPatterns lives in the relay-workspace repo
# (tests/test_intent.py) since it imports relay_discussion.harness_adapter.
#
# The tests below this point were removed during the repo split.
# Only harness-generic intent tests remain here.
